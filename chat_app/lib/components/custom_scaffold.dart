...
class CustomScaffold extends StatefulWidget {
  CustomScaffold({super.key, this.title, required this.body,this.resizeToAvoidBottomInset,this.centerTitle, this.leading, this.actions, this.bottomNavigationBar});
  final Widget body;
  final String? title;
